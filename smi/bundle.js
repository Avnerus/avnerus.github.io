...
var _qwertyHancock = require('qwerty-hancock');

var _qwertyHancock2 = _interopRequireDefault(_qwertyHancock);
...
var Game = function () {
    ...
    _createClass(Game, [{
        ...
        value: function init() {
            ...
            _tone2.default.Sampler.prototype.triggerAttackWithOffset = function (name, time, velocity, offset) {
            ...
            this.keyboard = new _qwertyHancock2.default({
                id: 'keyboard',
                width: 600,
                height: 150,
                octaves: 2,
...
},{"qwerty-hancock":3,"tone":4}],2:[function(require,module,exports){
'use strict';
